...
const HexIcon = (props: SVGProps<SVGSVGElement>) => createElement(BarChart2, props)
...
export const HexBlock: BlockConfig = {
  ...
  docsLink: 'https://docs.zelaxy.ai/tools/hex',
  category: 'tools',
  bgColor: '#14151A',
  icon: HexIcon,
  subBlocks: [
...
Example:
{
  ...
  outputs: {
    ...
    status: { type: 'json', description: 'Project status object or run status string' },
    ...
    owner: { type: 'json', description: 'Owner details' },
