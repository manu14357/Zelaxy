...
const GranolaIcon = (props: SVGProps<SVGSVGElement>) => createElement(Grape, props)
...
export const GranolaBlock: BlockConfig = {
  ...
  docsLink: 'https://docs.zelaxy.ai/tools/granola',
  category: 'tools',
  bgColor: '#B2C147',
  icon: GranolaIcon,
  ...
  outputs: {
    ...
    transcript: { type: 'json', description: 'Meeting transcript (if requested)' },
  },
}
