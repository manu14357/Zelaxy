...
export const FileBlock: BlockConfig<FileParserOutput> = {
  ...
  longDescription: `Upload and extract contents from structured file formats including PDFs, CSV spreadsheets, Word documents (DOCX), CAD files (DWG, DXF), engineering models (STEP, STP, IGES), images, and Excel spreadsheets. DWG and STEP files are automatically converted to PDF for text extraction. You can either provide a URL to a file or upload files directly. Specialized parsers extract text and metadata from each format. You can upload multiple files at once and access them individually or as a combined document.`,
  docsLink: '#',
  category: 'tools',
  bgColor: '#40916C',
  icon: DocumentIcon,
