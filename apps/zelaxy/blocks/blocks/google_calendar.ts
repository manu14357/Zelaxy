...
export const GoogleCalendarBlock: BlockConfig<GoogleCalendarResponse> = {
  ...
  subBlocks: [
    ...
    },
    {
      ...
      type: 'short-input',
      layout: 'half',
      placeholder: '2025-10-28T14:00:00-08:00 (or 2025-10-28T22:00:00Z for UTC)',
      condition: { field: 'operation', value: 'create' },
      required: true,
    },
    {
      ...
      type: 'short-input',
      layout: 'half',
      placeholder: '2025-10-28T15:00:00-08:00 (or 2025-10-28T23:00:00Z for UTC)',
      condition: { field: 'operation', value: 'create' },
      required: true,
    },
    {
    ...
    // List Events Fields
    {
      ...
      type: 'short-input',
      layout: 'half',
      placeholder: '2025-10-28T00:00:00Z (UTC) or 2025-10-28T00:00:00+05:30 (IST)',
    ...
    },
    {
      ...
      type: 'short-input',
      layout: 'half',
      placeholder: '2025-10-29T00:00:00Z (UTC) or 2025-10-29T00:00:00+05:30 (IST)',
      condition: { field: 'operation', value: 'list' },
    },
