...
export const ashbyListApplicationsTool: ToolConfig<
  AshbyListApplicationsParams,
  AshbyListApplicationsResponse
> = {
  ...
  outputs: {
    applications: {
      ...
      items: { type: 'object', properties: APPLICATION_OUTPUTS },
    },
    moreDataAvailable: { type: 'boolean', description: 'Whether more pages of results exist' },
    nextCursor: {
      type: 'string',
