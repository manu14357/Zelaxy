import type { AshbyUpdateCandidateParams, AshbyUpdateCandidateResponse } from '@/tools/ashby/types'
import {
  ashbyAuthHeaders,
  ashbyErrorMessage,
  CANDIDATE_OUTPUTS,
...
export const ashbyUpdateCandidateTool: ToolConfig<
  AshbyUpdateCandidateParams,
  AshbyUpdateCandidateResponse
> = {
  ...
  params: {
    ...
    socialLinks: {
      ...
      visibility: 'user-or-llm',
      description:
        'Array of social link objects to set on the candidate, e.g. [{"type":"LinkedIn","url":"https://..."}]',
    },
  },
  ...
  request: {
    ...
    body: (params) => {
      const body: Record<string, unknown> = { candidateId: params.candidateId.trim() }
  ...
  transformResponse: async (response: Response) => {
    ...
    return { success: true, output: mapCandidate(data.results) }
  },
