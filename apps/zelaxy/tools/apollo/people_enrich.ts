...
> = {
  ...
  params: {
    ...
    webhook_url: {
      ...
      required: false,
      visibility: 'user-only',
      description: 'Webhook URL for async phone number delivery',
    },
  },
  ...
  outputs: {
    person: { type: 'json', description: 'Enriched person data from Apollo', optional: true },
