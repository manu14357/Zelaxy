...
export const asanaSearchTasksTool: ToolConfig<AsanaSearchTasksParams, AsanaSearchTasksResponse> = {
  ...
  params: {
    ...
    workspace: {
      ...
      description: 'Asana workspace GID to search tasks in',
    },
    text: {
      type: 'string',
      required: false,
    ...
    projects: {
      ...
      required: false,
      visibility: 'user-or-llm',
      description: 'Array of Asana project GIDs to filter tasks by',
    },
    completed: {
      type: 'boolean',
      required: false,
  ...
  outputs: {
    ...
    next_page: { type: 'json', description: 'Pagination info', optional: true },
  },
}
