import type {
  DuckDuckGoTextSearchParams,
  DuckDuckGoTextSearchResponse,
} from '@/tools/duckduckgo/types'
import type { ToolConfig } from '@/tools/types'

export const textSearchTool: ToolConfig<DuckDuckGoTextSearchParams, DuckDuckGoTextSearchResponse> =
  {
    id: 'duckduckgo_text_search',
    ...
    outputs: {
      ...
      type: {
        type: 'string',
        description: 'Response type: A (article), D (disambiguation), C (category)',
      },
      relatedTopics: {
        type: 'array',
