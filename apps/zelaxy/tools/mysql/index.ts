...
import type { MySQLQueryParams, MySQLResponse } from './types'

export const mysqlTool: ToolConfig<MySQLQueryParams, MySQLResponse> = {
  id: 'mysql_database',
  name: 'MySQL',
  ...
  transformResponse: async (
    ...
    try {
      ...
      return result as MySQLResponse
    } catch (error) {
      return {
        success: false,
        output: {},
