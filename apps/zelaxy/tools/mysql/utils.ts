import type { MySQLConnectionParams } from './types'

/**
 * Validates MySQL connection parameters
 */
export function validateConnectionParams(params: MySQLConnectionParams): string[] {
  const errors: string[] = []
