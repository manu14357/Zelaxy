...
export const listChargesTool: ToolConfig<ListParams, StripeListResponse> = {
  ...
  outputs: {
    data: { type: 'json', description: 'Array of Stripe charge objects' },
    metadata: {
      type: 'json',
