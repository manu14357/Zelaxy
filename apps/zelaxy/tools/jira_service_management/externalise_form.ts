import type {
  JiraSmExternaliseFormParams,
  JiraSmExternaliseFormResponse,
...
export const jiraServiceManagementExternaliseFormTool: ToolConfig<
  JiraSmExternaliseFormParams,
  JiraSmExternaliseFormResponse
> = {
  id: 'jira_service_management_externalise_form',
  name: 'Jira Service Management Externalise Form',
  ...
  request: {
    url: (params) =>
      `${getJsmFormsApiBaseUrl(params.cloudId)}/issue/${encodeURIComponent(params.issueIdOrKey)}/form/${encodeURIComponent(params.formId)}/action/external`,
    method: 'PUT',
