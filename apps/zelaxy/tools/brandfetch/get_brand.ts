...
> = {
  ...
  outputs: {
    ...
    name: { type: 'string', description: 'Brand name', optional: true },
    domain: { type: 'string', description: 'Brand domain' },
    claimed: { type: 'boolean', description: 'Whether the brand profile is claimed' },
    description: { type: 'string', description: 'Short brand description', optional: true },
    longDescription: { type: 'string', description: 'Detailed brand description', optional: true },
    links: {
      type: 'array',
    ...
    isNsfw: { type: 'boolean', description: 'Whether the brand contains adult content' },
  },
}
