...
export async function downloadAttachments(
  ...
  for (const attachment of attachmentInfo) {
    try {
      ...
      // Extract basic text content from text-based files only.
      // Full content extraction (PDF, CAD, DOCX, etc.) is handled server-side
      // by the Gmail polling service and file parse API — NOT here, because
      // this module is in the client bundle chain and importing file-parsers
      // would pull in child_process / Node.js-only modules.
