import type { ParallelSearchParams, ParallelSearchResponse } from '@/tools/parallel/types'
import type { ToolConfig } from '@/tools/types'

export const searchTool: ToolConfig<ParallelSearchParams, ParallelSearchResponse> = {
  id: 'parallel_search',
  ...
  outputs: {
    search_id: { type: 'string', description: 'Unique identifier for this search request' },
    results: {
      type: 'array',
      description: 'Search results with excerpts',
      items: {
        type: 'object',
        properties: {
