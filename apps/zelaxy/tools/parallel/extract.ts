import type { ParallelExtractParams, ParallelExtractResponse } from '@/tools/parallel/types'
import type { ToolConfig } from '@/tools/types'

export const extractTool: ToolConfig<ParallelExtractParams, ParallelExtractResponse> = {
  id: 'parallel_extract',
  ...
  outputs: {
    extract_id: { type: 'string', description: 'Unique identifier for this extraction request' },
    results: {
      type: 'array',
      ...
      items: {
        ...
        properties: {
          ...
          publish_date: { type: 'string', description: 'Publication date (YYYY-MM-DD)' },
          excerpts: {
            type: 'array',
            description: 'Relevant text excerpts in markdown',
            items: { type: 'string' },
          },
          full_content: { type: 'string', description: 'Full page content as markdown' },
        },
      },
    },
  },
