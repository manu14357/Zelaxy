...
import { buildUpdateRecordUrl, executeAgiloftRequest } from './utils'

export const agiloftUpdateRecordTool: ToolConfig = {
  ...
  params: {
    ...
    data: {
      ...
      required: true,
      visibility: 'user-or-llm',
      description: 'Updated field values as a JSON object',
    },
  },
    ...
    return executeAgiloftRequest(
      ...
      async (response) => {
        ...
        return {
          ...
          output: { id: id != null ? String(id) : null, fields: result ?? {} },
        }
      }
    )
  },
  ...
  outputs: {
    id: { type: 'string', description: 'ID of the updated record' },
    fields: { type: 'json', description: 'Updated field values of the record' },
  },
}
