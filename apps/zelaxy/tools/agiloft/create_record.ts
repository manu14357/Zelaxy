...
import { buildCreateRecordUrl, executeAgiloftRequest } from './utils'

export const agiloftCreateRecordTool: ToolConfig = {
  ...
  params: {
    ...
    data: {
      ...
      required: true,
      visibility: 'user-or-llm',
      description: 'Record field values as a JSON object (e.g., {"first_name": "John"})',
    },
  },
  ...
  outputs: {
    ...
    fields: { type: 'json', description: 'Field values of the created record' },
  },
}
