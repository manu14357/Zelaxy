...
import { buildDeleteRecordUrl, executeAgiloftRequest } from './utils'

export const agiloftDeleteRecordTool: ToolConfig = {
  ...
  outputs: {
    ...
    deleted: { type: 'boolean', description: 'Whether the record was successfully deleted' },
  },
}
