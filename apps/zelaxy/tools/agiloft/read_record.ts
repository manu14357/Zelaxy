...
import { buildReadRecordUrl, executeAgiloftRequest } from './utils'

export const agiloftReadRecordTool: ToolConfig = {
  ...
  outputs: {
    id: { type: 'string', description: 'ID of the record' },
    fields: { type: 'json', description: 'Field values of the record' },
  },
}
