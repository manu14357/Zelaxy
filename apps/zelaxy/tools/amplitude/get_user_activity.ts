import type {
  AmplitudeGetUserActivityParams,
  AmplitudeGetUserActivityResponse,
} from '@/tools/amplitude/types'
import type { ToolConfig } from '@/tools/types'

export const amplitudeGetUserActivityTool: ToolConfig<
  AmplitudeGetUserActivityParams,
  AmplitudeGetUserActivityResponse
> = {
  id: 'amplitude_get_user_activity',
  ...
  transformResponse: async (response: Response) => {
    ...
    const userData = ud
      ...
      : null
    return { success: true, output: { events, userData } }
  },
  ...
  outputs: {
    ...
    userData: { type: 'json', description: 'User metadata', optional: true },
  },
}
