...
export const amplitudeIdentifyUserTool: ToolConfig<
  AmplitudeIdentifyUserParams,
  AmplitudeIdentifyUserResponse
> = {
  ...
  request: {
    ...
    body: (params) => {
      ...
      return { api_key: params.apiKey, identification: [identification] }
    },
  },
  ...
  outputs: {
    code: { type: 'number', description: 'HTTP response status code' },
    message: { type: 'string', description: 'Response message', optional: true },
  },
}
