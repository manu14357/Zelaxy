import type { BrexListCashAccountsParams, BrexListResponse } from '@/tools/brex/types'
import type { ToolConfig } from '@/tools/types'

export const listCashAccountsTool: ToolConfig<BrexListCashAccountsParams, BrexListResponse> = {
  id: 'brex_list_cash_accounts',
  name: 'Brex List Cash Accounts',
  description: 'List Brex cash accounts with balances and account details',
  version: '1.0.0',
  ...
  request: {
    url: (params) => {
      ...
      return qs
        ? `https://api.brex.com/v2/accounts/cash?${qs}`
  ...
  outputs: {
    data: { type: 'json', description: 'Array of Brex cash account objects' },
    metadata: {
      type: 'json',
