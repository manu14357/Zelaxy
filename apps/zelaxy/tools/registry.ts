...
import {
  createRequestTool,
  getRequestTool,
  jiraServiceManagementAddCommentTool,
  jiraServiceManagementAddCustomerTool,
  jiraServiceManagementAddOrganizationTool,
  jiraServiceManagementAddParticipantsTool,
  jiraServiceManagementAnswerApprovalTool,
  jiraServiceManagementAttachFormTool,
  jiraServiceManagementCopyFormsTool,
  jiraServiceManagementCreateObjectTool,
  jiraServiceManagementCreateOrganizationTool,
  jiraServiceManagementDeleteFormTool,
  jiraServiceManagementDeleteObjectTool,
  jiraServiceManagementExternaliseFormTool,
  jiraServiceManagementGetApprovalsTool,
  jiraServiceManagementGetCommentsTool,
  jiraServiceManagementGetCustomersTool,
  jiraServiceManagementGetFormAnswersTool,
  jiraServiceManagementGetFormStructureTool,
  jiraServiceManagementGetFormTemplatesTool,
  jiraServiceManagementGetFormTool,
  jiraServiceManagementGetIssueFormsTool,
  jiraServiceManagementGetObjectSchemaTool,
  jiraServiceManagementGetObjectTool,
  jiraServiceManagementGetObjectTypeAttributesTool,
  jiraServiceManagementGetOrganizationsTool,
  jiraServiceManagementGetParticipantsTool,
  jiraServiceManagementGetQueuesTool,
  jiraServiceManagementGetRequestTypeFieldsTool,
  jiraServiceManagementGetRequestTypesTool,
  jiraServiceManagementGetSlaTool,
  jiraServiceManagementGetTransitionsTool,
  jiraServiceManagementInternaliseFormTool,
  jiraServiceManagementListObjectSchemasTool,
  jiraServiceManagementListObjectTypesTool,
  jiraServiceManagementReopenFormTool,
  jiraServiceManagementSaveFormAnswersTool,
  jiraServiceManagementSearchObjectsAqlTool,
  jiraServiceManagementSubmitFormTool,
  jiraServiceManagementTransitionRequestTool,
  jiraServiceManagementUpdateObjectTool,
  listRequestsTool,
...
export const tools: Record<string, ToolConfig> = {
  ...
  jira_service_management_add_comment: jiraServiceManagementAddCommentTool,
  jira_service_management_add_customer: jiraServiceManagementAddCustomerTool,
  jira_service_management_add_organization: jiraServiceManagementAddOrganizationTool,
  jira_service_management_add_participants: jiraServiceManagementAddParticipantsTool,
  jira_service_management_answer_approval: jiraServiceManagementAnswerApprovalTool,
  jira_service_management_attach_form: jiraServiceManagementAttachFormTool,
  jira_service_management_copy_forms: jiraServiceManagementCopyFormsTool,
  jira_service_management_create_object: jiraServiceManagementCreateObjectTool,
  jira_service_management_create_organization: jiraServiceManagementCreateOrganizationTool,
  jira_service_management_create_request: createRequestTool,
  jira_service_management_delete_form: jiraServiceManagementDeleteFormTool,
  jira_service_management_delete_object: jiraServiceManagementDeleteObjectTool,
  jira_service_management_externalise_form: jiraServiceManagementExternaliseFormTool,
  jira_service_management_get_approvals: jiraServiceManagementGetApprovalsTool,
  jira_service_management_get_comments: jiraServiceManagementGetCommentsTool,
  jira_service_management_get_customers: jiraServiceManagementGetCustomersTool,
  jira_service_management_get_form: jiraServiceManagementGetFormTool,
  jira_service_management_get_form_answers: jiraServiceManagementGetFormAnswersTool,
  jira_service_management_get_form_structure: jiraServiceManagementGetFormStructureTool,
  jira_service_management_get_form_templates: jiraServiceManagementGetFormTemplatesTool,
  jira_service_management_get_issue_forms: jiraServiceManagementGetIssueFormsTool,
  jira_service_management_get_object: jiraServiceManagementGetObjectTool,
  jira_service_management_get_object_schema: jiraServiceManagementGetObjectSchemaTool,
  jira_service_management_get_object_type_attributes:
    jiraServiceManagementGetObjectTypeAttributesTool,
  jira_service_management_get_organizations: jiraServiceManagementGetOrganizationsTool,
  jira_service_management_get_participants: jiraServiceManagementGetParticipantsTool,
  jira_service_management_get_queues: jiraServiceManagementGetQueuesTool,
  jira_service_management_get_request: getRequestTool,
  jira_service_management_get_request_type_fields: jiraServiceManagementGetRequestTypeFieldsTool,
  jira_service_management_get_request_types: jiraServiceManagementGetRequestTypesTool,
  jira_service_management_get_sla: jiraServiceManagementGetSlaTool,
  jira_service_management_get_transitions: jiraServiceManagementGetTransitionsTool,
  jira_service_management_internalise_form: jiraServiceManagementInternaliseFormTool,
  jira_service_management_list_object_schemas: jiraServiceManagementListObjectSchemasTool,
  jira_service_management_list_object_types: jiraServiceManagementListObjectTypesTool,
  jira_service_management_list_requests: listRequestsTool,
  jira_service_management_list_servicedesks: listServiceDesksTool,
  jira_service_management_reopen_form: jiraServiceManagementReopenFormTool,
  jira_service_management_save_form_answers: jiraServiceManagementSaveFormAnswersTool,
  jira_service_management_search_objects_aql: jiraServiceManagementSearchObjectsAqlTool,
  jira_service_management_submit_form: jiraServiceManagementSubmitFormTool,
  jira_service_management_transition_request: jiraServiceManagementTransitionRequestTool,
  jira_service_management_update_object: jiraServiceManagementUpdateObjectTool,
