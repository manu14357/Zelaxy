...
export const tools: Record<string, ToolConfig> = {
  ...
  temporal_signal_with_start_workflow: temporalSignalWithStartWorkflowTool,
  ...
  temporal_update_schedule: temporalUpdateScheduleTool,
  ...
  temporal_describe_namespace: temporalDescribeNamespaceTool,
  ...
  ssh_run_script: sshRunScriptTool,
  ssh_read_file: sshReadFileTool,
  ssh_write_file: sshWriteFileTool,
  ssh_append_file: sshAppendFileTool,
  ssh_delete_file: sshDeleteFileTool,
  ssh_rename: sshRenameTool,
  ssh_file_stat: sshFileStatTool,
  ssh_change_permissions: sshChangePermissionsTool,
  ssh_list_directory: sshListDirectoryTool,
  ssh_create_directory: sshCreateDirectoryTool,
  ssh_remove_directory: sshRemoveDirectoryTool,
  ssh_check_exists: sshCheckExistsTool,
  sftp_list: sftpListTool,
  sftp_get: sftpGetTool,
  sftp_put: sftpPutTool,
