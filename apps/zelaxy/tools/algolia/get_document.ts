import type { AlgoliaGetDocumentParams, AlgoliaGetDocumentResponse } from '@/tools/algolia/types'
import type { ToolConfig } from '@/tools/types'

export const algoliaGetDocumentTool: ToolConfig<
  AlgoliaGetDocumentParams,
  AlgoliaGetDocumentResponse
> = {
  id: 'algolia_get_document',
  ...
  outputs: {
    objectID: { type: 'string', description: 'The objectID of the retrieved record' },
    record: { type: 'object', description: 'The record data (all attributes)' },
  },
}
