import type {
  AlgoliaIndexDocumentParams,
  AlgoliaIndexDocumentResponse,
} from '@/tools/algolia/types'
import type { ToolConfig } from '@/tools/types'

export const algoliaIndexDocumentTool: ToolConfig<
  AlgoliaIndexDocumentParams,
  AlgoliaIndexDocumentResponse
> = {
  id: 'algolia_index_document',
  ...
  outputs: {
    taskID: { type: 'number', description: 'Algolia task ID for tracking the indexing operation' },
    objectID: { type: 'string', description: 'The object ID of the added or replaced record' },
    createdAt: { type: 'string', description: 'Timestamp when created', optional: true },
    updatedAt: { type: 'string', description: 'Timestamp when updated', optional: true },
  },
}
