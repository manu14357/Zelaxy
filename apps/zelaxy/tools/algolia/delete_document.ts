import type {
  AlgoliaDeleteDocumentParams,
  AlgoliaDeleteDocumentResponse,
} from '@/tools/algolia/types'
import type { ToolConfig } from '@/tools/types'

export const algoliaDeleteDocumentTool: ToolConfig<
  AlgoliaDeleteDocumentParams,
  AlgoliaDeleteDocumentResponse
> = {
  id: 'algolia_delete_document',
  ...
  outputs: {
    taskID: { type: 'number', description: 'Algolia task ID for tracking the deletion' },
    deletedAt: { type: 'string', description: 'Timestamp when the record was deleted' },
  },
}
