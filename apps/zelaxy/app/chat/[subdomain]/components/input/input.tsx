...
export const ChatInput: React.FC<{
  ...
  // Check if speech-to-text is available in the browser (deferred to client to avoid hydration mismatch)
  const [isSttAvailable, setIsSttAvailable] = useState(false)
  useEffect(() => {
    setIsSttAvailable(!!(window.SpeechRecognition || (window as any).webkitSpeechRecognition))
  }, [])
