...
export function useVerification({
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // Check if this is an invite flow (sessionStorage first, cookie fallback)
      const storedIsInviteFlow = sessionStorage.getItem('isInviteFlow') || getCookie('isInviteFlow')
