  ...
  ({
    ...
    const renderWorkspaceInfo = () => (
      <>
        ...
        <div className='flex min-w-0 flex-1 items-center pl-1'>
          <span
            className='truncate font-semibold text-[13px] text-foreground leading-none tracking-tight'
            style={{
              minHeight: '1rem',
              lineHeight: '1rem',
            }}
    ...
    return (
      <div className='h-12 rounded-xl border border-border/60 bg-card/50 shadow-sm backdrop-blur-sm'>
        <div
          className='flex h-full cursor-pointer items-center gap-1.5 pr-2.5 pl-3 transition-colors hover:bg-accent/40'
