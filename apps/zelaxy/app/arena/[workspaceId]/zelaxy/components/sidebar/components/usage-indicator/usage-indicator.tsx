...
const CONTAINER_STYLES =
  'pointer-events-auto flex-shrink-0 rounded-xl border border-border/60 bg-card/50 px-3 py-2.5 shadow-sm backdrop-blur-sm cursor-pointer transition-all hover:bg-accent/40 hover:border-border'
