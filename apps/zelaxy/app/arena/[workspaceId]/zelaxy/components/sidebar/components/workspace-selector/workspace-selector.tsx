      ...
      return (
        <div className='space-y-1'>
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className='flex h-8 items-center rounded-lg p-2 text-left'
        ...
        {workspaces.map((workspace) => {
          ...
          return (
            <div
              ...
              className={cn(
                'group flex h-8 cursor-pointer items-center rounded-lg p-2 text-left transition-colors',
                activeWorkspace?.id === workspace.id ? 'bg-muted/70' : 'hover:bg-muted/50'
              )}
              style={{ maxWidth: '206px' }}
            >
              <div className='flex min-w-0 flex-1 items-center text-left'>
    ...
    <>
      <div className='rounded-xl border border-border/60 bg-card/50 shadow-sm backdrop-blur-sm'>
        <div className='flex h-full flex-col p-2'>
          ...
          {/* Bottom Actions */}
          <div className='mt-2 flex items-center gap-1.5 border-border/40 border-t pt-2'>
            ...
            {!isDev && (
              <Button
                ...
                className={cn(
                  'h-8 flex-1 justify-center gap-1.5 rounded-lg font-medium text-[12px] text-muted-foreground transition-colors hover:bg-accent/70 hover:text-foreground'
                )}
              >
