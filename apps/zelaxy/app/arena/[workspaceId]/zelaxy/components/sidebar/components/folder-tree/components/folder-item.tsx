...
// Function to get a consistent color for a folder based on its ID
...
export function FolderItem({
  ...
  const handleCreateWorkflowInFolder = async (e: React.MouseEvent) => {
    e.stopPropagation()
    try {
      await onCreateWorkflow(folder.id)
    } catch (error) {
        ...
        >
          <div className='mr-2 flex h-[14px] w-[14px] flex-shrink-0 items-center justify-center'>
            {isExpanded ? (
              ...
              <Folder className='h-[14px] w-[14px]' style={{ color: getFolderColor(folder.id) }} />
            )}
          </div>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    onClick={handleCreateWorkflowInFolder}
                  >
                    <Plus className='!h-3.5 !w-3.5' />
                    <span className='sr-only'>Create workflow in folder</span>
                  </Button>
                </TooltipTrigger>
                <TooltipContent side='bottom'>Create workflow in folder</TooltipContent>
              </Tooltip>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                ...
                <TooltipContent side='bottom'>Rename folder</TooltipContent>
              </Tooltip>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                ...
                <TooltipContent side='bottom'>Delete folder</TooltipContent>
              </Tooltip>
            </div>
          )}
        </div>
