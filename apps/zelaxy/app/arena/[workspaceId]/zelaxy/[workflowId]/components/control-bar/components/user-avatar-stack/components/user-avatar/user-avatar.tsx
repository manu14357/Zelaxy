...
const APP_COLORS = [
  { from: '#1e40af', to: '#F97316' }, // blue to blue
  { from: '#F97316', to: '#F97316' }, // blue to blue
  { from: '#EC4899', to: '#F97316' }, // pink to orange
  { from: '#14B8A6', to: '#10B981' }, // teal to emerald
  { from: '#EA580C', to: '#F97316' }, // blue to blue
...
export function UserAvatar({
  ...
  const avatarElement = (
    <div
      className={`
        ${sizeClass} flex flex-shrink-0 cursor-default items-center justify-center border-2 border-white font-semibold text-white shadow-sm `}
      style={
        {
