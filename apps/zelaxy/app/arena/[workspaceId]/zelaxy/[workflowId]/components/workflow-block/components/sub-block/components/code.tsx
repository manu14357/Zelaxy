...
export function Code({
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    try {
      ...
      const newCursorPosition = dropPosition + 2
  ...
  return (
    <>
      ...
      <div
        ...
        onDrop={handleDrop}
      >
        {/* AI Button - positioned differently based on field type */}
        <div
          className={cn(
            'absolute z-10 flex items-center gap-1 opacity-0 transition-opacity group-hover:opacity-100',
            subBlockId === 'responseFormat' ? 'right-3 bottom-2' : 'bottom-2 left-3'
          )}
        >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      'h-8 w-8 rounded-md border-0 bg-transparent text-primary transition-all duration-200 hover:bg-primary/5 hover:text-primary dark:text-primary/80 dark:hover:bg-primary/15 dark:hover:text-primary/70'
                    )}
                  >
