...
import { categories } from '@/app/arena/[workspaceId]/templates/templates'
                                ...
                                {icons.map((icon) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={cn(
                                        'flex h-8 w-8 items-center justify-center border transition-colors hover:bg-muted',
              ...
              <div className='flex justify-end'>
                <Button
                  ...
                  className={cn(
                    ...
                    'shadow-[0_0_0_0_hsl(var(--primary))] hover:shadow-[0_0_0_4px_hsl(var(--primary)/0.15)]',
