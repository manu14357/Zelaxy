        ...
        <div className='w-full py-1.5'>
          ...
          <div className='flex justify-end'>
            <div className='max-w-[80%]'>
              ...
              >
                <div className='whitespace-pre-wrap break-words font-normal text-foreground text-xs leading-relaxed'>
                ...
                <div className='mt-1 flex justify-end'>
                  {showRestoreConfirmation ? (
                    <div className='flex items-center gap-1.5'>
                      <span className='text-[10px] text-muted-foreground'>Restore?</span>
                      <button
                        onClick={handleConfirmRevert}
                        disabled={isRevertingCheckpoint}
                        className='rounded p-0.5 text-muted-foreground text-xs transition-colors hover:bg-muted disabled:cursor-not-allowed disabled:opacity-50'
                    ...
                    <button
                      ...
                      disabled={isRevertingCheckpoint}
                      className='flex items-center gap-1 rounded px-1.5 py-0.5 text-[10px] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground disabled:cursor-not-allowed disabled:opacity-50'
        ...
        <div className='w-full max-w-full overflow-hidden py-1.5 pl-[2px]'>
          <div className='max-w-full space-y-1.5 text-xs transition-all duration-200 ease-in-out'>
              ...
              <div className='mt-1 flex items-center gap-1.5'>
                ...
                >
                  {showCopySuccess ? (
                    ...
                    <Clipboard className='h-2.5 w-2.5' strokeWidth={2} />
                  )}
                </button>
                <button
                ...
                >
                  {showDownvoteSuccess ? (
                    ...
                    <ThumbsDown className='h-2.5 w-2.5' strokeWidth={2} />
                  )}
                </button>
              </div>
            )}
            ...
            {message.citations && message.citations.length > 0 && (
              <div className='pt-1'>
                <div className='font-medium text-[10px] text-muted-foreground'>Sources:</div>
                <div className='mt-0.5 flex flex-wrap gap-1.5'>
                  {message.citations.map((citation) => (
                    <a
                      ...
                      className='inline-flex items-center rounded border bg-muted/50 px-1.5 py-0.5 text-[10px] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground'
                    >
                      {citation.title}
                    </a>
                  ))}
