...
import { CodeEditor } from '@/app/arena/[workspaceId]/zelaxy/[workflowId]/components/workflow-block/components/sub-block/components/tool-input/components/code-editor/code-editor'
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            variant='ghost'
                            size='icon'
                            className='h-5 w-5 rounded border-0 bg-transparent p-0 text-primary transition-all duration-200 hover:bg-primary/5 hover:text-primary dark:text-primary/80 dark:hover:bg-primary/15 dark:hover:text-primary/70'
                            onClick={() => {
                          ...
                          >
                            <ZelaxyLogo size={12} variant='blue' />
                          </Button>
                        </TooltipTrigger>
                        <TooltipContent>
