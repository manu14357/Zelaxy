  ...
  return (
    <div className='space-y-4'>
      <div className='space-y-2'>
        ...
        <div className='relative flex items-center ring-offset-background'>
          <a
            href={deployedUrl}
            target='_blank'
            rel='noopener noreferrer'
            className='flex h-10 flex-1 items-center break-all border border-r-0 p-2 font-medium text-primary text-sm'
          >
            {subdomainPart}
          </a>
          <div className='flex h-10 items-center whitespace-nowrap border border-l-0 bg-muted px-3 font-medium text-muted-foreground text-sm'>
            {domainSuffix}
          </div>
        </div>
