...
import { WebhookModal } from '@/app/arena/[workspaceId]/zelaxy/[workflowId]/components/workflow-block/components/sub-block/components/webhook/components'
...
export const WEBHOOK_PROVIDERS: { [key: string]: WebhookProvider } = {
  ...
  generic: {
    ...
    icon: (props) => (
      ...
      >
        <span className='font-medium text-white text-xs'>Zelaxy</span>
      </div>
    ),
    configFields: {
      token: {
