    ...
    <>
      ...
      <div className='group relative'>
        ...
        >
          ...
          {/* Parallel Header - styled like WorkflowBlock */}
          <div className='workflow-drag-handle absolute top-0 right-0 left-0 z-10 flex cursor-grab items-center justify-between overflow-hidden rounded-t-2xl border-border/40 border-b bg-background/90 p-3 backdrop-blur-xl dark:bg-background/80'>
            <div className='flex min-w-0 flex-1 items-center gap-2.5'>
              <div
                ...
                style={{ backgroundColor: '#FEE12B' }}
              >
                <ParallelIcon className='h-3.5 w-3.5 text-white' />
              </div>
          ...
          {/* Inner left source handle — connects to child blocks inside the parallel */}
          <Handle
            type='source'
            position={Position.Right}
            id='parallel-start-source'
            className='!w-3 !h-5 !bg-amber-400 dark:!bg-amber-500 !rounded-full !border-2 !border-background !shadow-[0_1px_4px_rgba(0,0,0,0.15)] !z-[30] !pointer-events-auto hover:!w-3.5 hover:!h-6 hover:!bg-amber-500 !cursor-crosshair transition-all duration-150 ease-out'
            style={{
              left: '8px',
              top: '50%',
          ...
          <Handle
            ...
            className='!w-3 !h-5 !bg-orange-400 dark:!bg-orange-500 !rounded-full !border-2 !border-background !shadow-[0_1px_4px_rgba(0,0,0,0.15)] !z-[30] !pointer-events-auto hover:!w-3.5 hover:!h-6 hover:!bg-orange-500 !cursor-crosshair transition-all duration-150 ease-out'
            style={{
              left: '-7px',
              top: '50%',
              transform: 'translateY(-50%)',
          ...
          <Handle
            type='source'
            position={Position.Right}
            className='!w-3 !h-5 !bg-orange-300 dark:!bg-orange-400/80 !rounded-full !border-2 !border-background !shadow-[0_1px_4px_rgba(0,0,0,0.15)] !z-[30] !pointer-events-auto hover:!w-3.5 hover:!h-6 hover:!bg-orange-400 !cursor-crosshair transition-all duration-150 ease-out'
            style={{
              right: '-7px',
              top: '50%',
              transform: 'translateY(-50%)',
