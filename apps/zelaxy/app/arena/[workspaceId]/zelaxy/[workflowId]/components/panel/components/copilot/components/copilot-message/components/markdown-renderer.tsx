  ...
  const markdownComponents = useMemo(
    () => ({
      ...
      p: ({ children }: React.HTMLAttributes<HTMLParagraphElement>) => (
        <p className='mb-1 min-w-0 font-geist-sans text-gray-800 text-xs leading-relaxed [overflow-wrap:anywhere] [word-break:break-word] last:mb-0 dark:text-gray-200'>
          {children}
        </p>
      ),
      ...
      li: ({
        ...
        <li
          className='min-w-0 font-geist-sans text-gray-800 [overflow-wrap:anywhere] [word-break:break-word] dark:text-gray-200'
      ...
      td: ({ children }: React.TdHTMLAttributes<HTMLTableCellElement>) => (
        <td className='break-words border-gray-300 border-r px-4 py-2 text-gray-800 [overflow-wrap:anywhere] last:border-r-0 dark:border-gray-700 dark:text-gray-200'>
          {children}
        </td>
      ),
      ...
      img: ({ src, alt, ...props }: React.ImgHTMLAttributes<HTMLImageElement>) => (
        <img src={src} alt={alt || 'Image'} className='my-3 h-auto max-w-full' {...props} />
      ),
    }),
    [copiedCodeBlocks]
  )
