      ...
      {workflowVariables.length === 0 ? (
        <div className='flex h-full items-center justify-center'>
          <Button
            ...
            className='h-9 rounded-lg border border-border bg-background px-3 py-1.5 font-normal text-muted-foreground text-sm shadow-xs transition-colors hover:text-muted-foreground dark:border-border dark:bg-card dark:hover:text-muted-foreground'
            variant='outline'
          >
        ...
        <ScrollArea className='h-full' hideScrollbar={true}>
          <div className='space-y-4'>
              ...
              <div key={variable.id} className='space-y-2'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      align='end'
                      className='min-w-32 rounded-lg border-border bg-background shadow-xs dark:border-border dark:bg-card'
                    >
                      <DropdownMenuItem
            ...
            <Button
              onClick={handleAddVariable}
              className='mt-2 h-9 w-full rounded-lg border border-border bg-background px-3 py-1.5 font-[380] text-muted-foreground text-sm shadow-xs transition-colors hover:text-muted-foreground dark:border-border dark:bg-card dark:hover:text-muted-foreground'
              variant='outline'
            >
              <Plus className='h-4 w-4' />
              Add variable
