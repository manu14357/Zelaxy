  ...
  const handleDrop = (e: React.DragEvent, fieldId: string) => {
    ...
    try {
      ...
      if (data.type === 'connectionBlock' && data.connectionData) {
        ...
        setTimeout(() => {
          input.selectionStart = dropPosition + 2
          input.selectionEnd = dropPosition + 2

          // Trigger dropdown by simulating the tag check
          const cursorPosition = dropPosition + 2
          const shouldShow = checkTagTrigger(newValue, cursorPosition)
                      ...
                      <div className='relative'>
                        <Input
                          ...
                          className={cn(
                            ...
                            dragHighlight[field.id] && 'ring-2 ring-primary ring-offset-2',
                            isConnecting &&
