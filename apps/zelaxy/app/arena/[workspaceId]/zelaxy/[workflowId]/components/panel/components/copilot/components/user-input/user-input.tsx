      ...
      <div className={cn('relative flex-none px-2 pb-2', className)}>
        ...
        >
          ...
          <Textarea
            ...
            disabled={disabled}
            rows={1}
            className='mb-1.5 min-h-[28px] w-full resize-none overflow-hidden border-0 bg-transparent px-1 py-0.5 text-muted-foreground text-xs focus-visible:ring-0 focus-visible:ring-offset-0'
            style={{ height: 'auto' }}
          />
