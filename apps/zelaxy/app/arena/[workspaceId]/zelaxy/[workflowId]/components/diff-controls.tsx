      ...
      <div className='rounded-lg border bg-background/95 p-4 shadow-lg backdrop-blur-sm'>
        <div className='flex items-center gap-4'>
          ...
          <div className='flex items-center gap-2'>
            <div className='flex h-8 w-8 items-center justify-center rounded-full bg-primary/15 dark:bg-primary/15'>
              <Eye className='h-4 w-4 text-primary dark:text-primary/80' />
            </div>
