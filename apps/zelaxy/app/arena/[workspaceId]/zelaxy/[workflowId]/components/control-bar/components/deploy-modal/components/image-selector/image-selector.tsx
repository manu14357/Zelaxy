      ...
      {value ? (
        ...
        <div className='space-y-2'>
          <div className='relative inline-block'>
            <img src={value} alt='Uploaded logo' className='h-20 w-20 border object-cover' />
            <Button
              type='button'
              variant='destructive'
              size='icon'
        ...
        <div
          ...
          onClick={handleClick}
          className={cn(
            'relative flex cursor-pointer flex-col items-center justify-center border-2 border-dashed p-6 text-center transition-colors',
            isDragging
