...
import { OAuthRequiredModal } from '@/app/arena/[workspaceId]/zelaxy/[workflowId]/components/workflow-block/components/sub-block/components/credential-selector/components/oauth-required-modal'
...
export function MicrosoftFileSelector({
  ...
  const getFileIcon = (file: MicrosoftFileInfo, size: 'sm' | 'md' = 'sm') => {
    ...
    //   return <FileIcon className={`${iconSize} text-primary`} />
    // }
