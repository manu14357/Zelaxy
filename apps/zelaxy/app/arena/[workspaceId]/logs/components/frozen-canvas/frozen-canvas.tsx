  ...
  return (
    <>
      <div>
        ...
        <div
          className={cn(
            'overflow-y-auto bg-muted p-3 font-mono text-xs transition-all duration-200',
      ...
      {isModalOpen && (
        <div className='fixed inset-0 z-[200] flex items-center justify-center bg-black/50'>
          <div className='mx-4 h-[80vh] w-full max-w-4xl border bg-background shadow-lg'>
      ...
      <Card className='fixed top-4 right-4 z-[100] max-h-[calc(100vh-8rem)] w-96 overflow-y-auto border-border bg-background shadow-lg'>
        <CardHeader className='pb-3'>
          <div className='flex items-center justify-between'>
            ...
            <button onClick={onClose} className='p-1 text-foreground hover:bg-muted'>
              <X className='h-4 w-4' />
            </button>
          </div>
          <div className='flex items-center justify-between'>
