...
export function ToolCallsDisplay({ metadata }: ToolCallsDisplayProps) {
  ...
  return (
    <div className='space-y-2'>
      <div className='border bg-secondary/20'>
          ...
          <div className='space-y-4'>
            ...
            {toolCall.input && (
              <div>
                ...
                <pre className='group relative max-h-32 overflow-y-auto overflow-x-hidden whitespace-pre-wrap break-all bg-background p-2'>
            ...
            {toolCall.status === 'error' && toolCall.error && (
              <div>
                ...
                <pre className='group relative max-h-32 overflow-y-auto overflow-x-hidden whitespace-pre-wrap break-all bg-destructive/10 p-2 text-destructive'>
