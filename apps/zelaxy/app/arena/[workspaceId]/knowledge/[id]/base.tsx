  ...
  switch (doc.processingStatus) {
    ...
    case 'processing':
      return {
        ...
        className:
          'inline-flex items-center rounded-md bg-primary/10 px-2 py-1 text-xs font-medium text-primary dark:bg-primary/20 dark:text-primary',
      }
    case 'failed':
      return {
        text: (
...
export function KnowledgeBase({
  ...
  const handleDocumentClick = (docId: string) => {
    ...
    router.push(`/arena/${workspaceId}/knowledge/${id}/${docId}?${urlParams.toString()}`)
  }
  ...
  const handleDeleteKnowledgeBase = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push(`/arena/${workspaceId}/hub?tab=knowledge`)
      } else {
        ...
        <div className='flex flex-1 items-center justify-center'>
          <div className='text-center'>
            ...
            <button
              ...
              className='text-primary text-sm underline hover:text-primary'
            >
              Reload page
            </button>
          </div>
                                  ...
                                  <Tooltip>
                                    ...
                                    <TooltipContent side='top'>
                                      ...
                                      doc.processingStatus === 'pending'
                                        ...
                                        : !userPermissions.canEdit
                                          ? 'Write access is required to modify documents'
                                          : doc.enabled
                                            ? 'Disable this document'
                                  ...
                                  <Tooltip>
                                    ...
                                    <TooltipContent side='top'>
                                      {doc.processingStatus === 'processing'
                                        ...
                                        : !userPermissions.canEdit
                                          ? 'Write access is required to delete documents'
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to permanently delete "{knowledgeBaseName}"? This will remove
