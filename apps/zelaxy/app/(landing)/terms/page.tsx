          ...
          <div className='relative px-4 py-4 sm:px-8'>
            ...
            <div className='space-y-8 text-white/80'>
              <section>
                ...
                <p>
                  Please read these Terms of Service ("Terms") carefully before using the Zelaxy
                  platform (the "Service") operated by Zelaxy, Inc ("us", "we", or "our").
                </p>
                <p className='mt-4'>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  remain the exclusive property of Zelaxy, Inc and its licensors. The Service is
                ...
                <p>
                  ...
                  service without the prior written consent of Zelaxy, Inc.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-primary'>
                  ...
                  <li>
                    To impersonate or attempt to impersonate Zelaxy, Inc, a Zelaxy employee, another
                  ...
                  <li>
                    ...
                    enjoyment of the Service, or which, as determined by us, may harm Zelaxy, Inc or
              ...
              <section>
                ...
                <p className='mb-4'>
                  In no event shall Zelaxy, Inc, nor its directors, employees, partners, agents,
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  arbitrate disputes with Zelaxy, Inc, its parent companies, subsidiaries,
                  ...
                  <span className='text-primary'>"Company Parties"</span>) and limits the manner in
              ...
              <section>
                ...
                <p>
                  ...
                  <Link
                    href='mailto:copyright@zelaxy.ai'
                    className='text-primary hover:text-primary/80'
                  >
                    copyright@zelaxy.ai
                  </Link>
