...
export function CTASection() {
  ...
  return (
    <section ref={sectionRef} className='relative bg-white py-28 dark:bg-[#060606] sm:py-36'>
      {/* Top divider */}
      ...
      {/* Ambient glow */}
      <div className='pointer-events-none absolute top-1/2 left-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-500/[0.04] blur-[140px]' />
      ...
      <div className='relative mx-auto max-w-3xl px-6 text-center lg:px-8'>
        ...
        >
          ...
          <span className='text-neutral-500 dark:text-neutral-400'>Open source &middot; MIT licensed</span>
        </div>
        ...
        {/* CTA buttons */}
        <div
          className={`flex flex-col items-center gap-3 sm:flex-row sm:justify-center transition-all delay-300 duration-700 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'
          }`}
        >
          <Button
            asChild
            size='lg'
            className='group h-12 w-full rounded-full bg-neutral-900 px-8 font-medium text-[15px] text-white transition-all duration-300 hover:bg-neutral-800 active:scale-[0.98] dark:bg-white dark:text-black dark:hover:bg-neutral-200 sm:w-auto'
          >
            <Link href='/signup'>
              Get Started Free
