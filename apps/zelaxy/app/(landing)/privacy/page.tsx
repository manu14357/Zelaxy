...
import { Footer, GridPattern, NavWrapper } from '@/app/(landing)/components'
            ...
            <div className='space-y-8 text-white/80'>
              <section>
                ...
                <p>
                  ...
                  and shared when you visit or use Zelaxy ("the Service", "we", "us", or "our").
                </p>
                <p className='mt-4'>
              ...
              <section>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Interpretation</h3>
                <p className='mb-4'>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Definitions</h3>
                <p className='mb-4'>For the purposes of this Privacy Policy:</p>
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-primary'>
                  <li>
                    <span className='text-primary'>Account</span> means a unique account created for
                    You to access our Service or parts of our Service.
                  </li>
                  <li>
                    <span className='text-primary'>Affiliate</span> means an entity that controls,
                  ...
                  <li>
                    <span className='text-primary'>Application</span> means the software program
                    provided by the Company downloaded by You on any electronic device.
                  </li>
                  <li>
                    <span className='text-primary'>Business</span>, for the purpose of the CCPA
                  ...
                  <li>
                    <span className='text-primary'>Company</span> (referred to as either "the
                    Company", "We", "Us" or "Our" in this Agreement) refers to Zelaxy. For the
                    purpose of the GDPR, the Company is the Data Controller.
                  </li>
                  <li>
                    <span className='text-primary'>Cookies</span> are small files that are placed on
                    Your computer, mobile device or any other device by a website, containing the
                    details of Your browsing history on that website among its many uses.
                  </li>
                  <li>
                    <span className='text-primary'>Country</span> refers to: Quebec, Canada
                  </li>
                  <li>
                    <span className='text-primary'>Data Controller</span>, for the purposes of the
                  ...
                  <li>
                    <span className='text-primary'>Device</span> means any device that can access
                    the Service such as a computer, a cellphone or a digital tablet.
                  </li>
                  <li>
                    <span className='text-primary'>Do Not Track (DNT)</span> is a concept that has
                  ...
                  <li>
                    <span className='text-primary'>Personal Data</span> is any information that
                  ...
                  <li>
                    <span className='text-primary'>Sale</span>, for the purpose of the CCPA
                  ...
                  <li>
                    <span className='text-primary'>Service</span> refers to the Application or the
                    Website or both.
                  </li>
                  <li>
                    <span className='text-primary'>Service Provider</span> means any natural or
                  ...
                  <li>
                    <span className='text-primary'>Third-party Social Media Service</span> refers to
                    any website or any social network website through which a User can log in or
                    create an account to use the Service.
                  </li>
                  <li>
                    <span className='text-primary'>Usage Data</span> refers to data collected
                    automatically, either generated by the use of the Service or from the Service
                    infrastructure itself (for example, the duration of a page visit).
                  </li>
                  <li>
                    <span className='text-primary'>Website</span> refers to Zelaxy, accessible from
                    zelaxy.ai
                  </li>
                  <li>
                    <span className='text-primary'>You</span> means the individual accessing or
              ...
              <section>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Personal Information</h3>
                <p className='mb-4'>
                  While using our Service, we may ask you to provide us with certain personally
                  identifiable information that can be used to contact or identify you (
                  <span className='text-primary'>"Personal Information"</span>). Personally
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Usage Data</h3>
                <p className='mb-4'>
                  We may also collect information on how the Service is accessed and used (
                  <span className='text-primary'>"Usage Data"</span>). This Usage Data may include
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Tracking & Cookies Data</h3>
                <p className='mb-4'>
              ...
              <section>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Business Transactions</h3>
                <p className='mb-4'>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Law Enforcement</h3>
                <p className='mb-4'>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Legal Requirements</h3>
                <p className='mb-4'>
                  Zelaxy may disclose your Personal Information in the good faith belief that such
                  action is necessary to:
                </p>
                <ul className='list-disc space-y-2 pl-6 marker:text-primary'>
                  <li>To comply with a legal obligation</li>
                  <li>To protect and defend the rights or property of Zelaxy</li>
                  <li>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  <span className='text-primary'>"Service Providers"</span>), to provide the Service
              ...
              <section>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Google Analytics</h3>
                <p className='mb-4'>
              ...
              <section>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Google Ads (AdWords)</h3>
                <p className='mb-4'>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Twitter</h3>
                <p className='mb-4'>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Facebook</h3>
                <p className='mb-4'>
              ...
              <section>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  APIs is <span className='text-primary'>not</span> used to develop, improve, or
              ...
              <section>
                ...
                <p className='mb-4'>
                  Zelaxy's use and transfer to any other app of information received from Google
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  protection rights. Zelaxy aims to take reasonable steps to allow you to correct,
                ...
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-primary'>
                  ...
                  <li>
                    ...
                    at any time where Zelaxy relied on your consent to process your personal
                    information.
                  </li>
                </ul>
                <p className='mb-4'>
                ...
                <p className='mb-4 border-primary border-l-4 bg-primary/10 p-3'>
              ...
              <section>
                ...
                <p className='mb-4'>
                  ...
                  <span className='text-primary'>"Shine The Light"</span> law, permits our users who
              ...
              <section>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Introduction</h3>
                <p className='mb-4'>
                  Zelaxy is dedicated to preserving data security by preventing unauthorized
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Guidelines</h3>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Authorization</h3>
                <p className='mb-4'>
                  ...
                  Zelaxy will not suggest or pursue legal action in connection with your study.
                </p>

                <h3 className='mb-2 font-medium text-primary text-xl'>Scope</h3>
                <p className='mb-4'>This policy applies to the following systems and services:</p>
                <ul className='mb-4 list-disc space-y-2 pl-6 marker:text-primary'>
                  <li>zelaxy.ai website</li>
                  <li>Zelaxy web application</li>
                  <li>Zelaxy API services</li>
                </ul>
                <p className='mb-4'>
                  ...
                  third-party solutions Zelaxy interacts with are not covered by this policy and
                  ...
                  <Link
                    href='mailto:security@zelaxy.ai'
                    className='text-primary hover:text-primary/80'
                  >
                    security@zelaxy.ai
                  </Link>{' '}
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Types of testing</h3>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Reporting a vulnerability</h3>
                <p className='mb-4'>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Desirable information</h3>
                <p className='mb-4'>
                ...
                <h3 className='mb-2 font-medium text-primary text-xl'>Our commitment</h3>
                <p className='mb-4'>
