...
export function ToolCallDetection({ content }: { content: string }) {
  return (
    <div className='flex min-w-0 items-center gap-2 rounded-lg border border-primary/30 bg-primary/10 px-3 py-2 text-sm dark:border-primary/30 dark:bg-primary/10'>
      <Loader2 className='h-4 w-4 shrink-0 animate-spin text-primary dark:text-primary/80' />
      <span className='min-w-0 truncate text-primary dark:text-primary/60'>{content}</span>
    </div>
  )
}
...
export function ToolCallGroupComponent({ group, isCompact = false }: ToolCallGroupProps) {
  ...
  return (
    <div className='min-w-0 space-y-2'>
      {group.summary && (
        <div className='flex min-w-0 items-center gap-2 rounded-lg border border-primary/30 bg-primary/10 px-3 py-2 text-sm dark:border-primary/30 dark:bg-primary/10'>
          <Settings className='h-4 w-4 shrink-0 text-primary dark:text-primary/80' />
          <span className='min-w-0 truncate text-primary dark:text-primary/60'>
            {group.summary}
          </span>
          {!isAllCompleted && (
            <Badge variant='outline' className='shrink-0 text-primary text-xs dark:text-primary/70'>
