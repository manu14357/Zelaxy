...
describe('TagDropdown Search and Filtering', () => {
  it.concurrent('should extract search term from input correctly', () => {
    const testCases = [
      { input: 'Hello {{var', cursorPosition: 11, expected: 'var' },
      { input: 'Hello {{Variable.', cursorPosition: 17, expected: 'variable.' },
      { input: 'Hello {{loop.in', cursorPosition: 15, expected: 'loop.in' },
      { input: 'Hello world', cursorPosition: 11, expected: '' },
      { input: 'Hello {{var}} and {{loo', cursorPosition: 24, expected: 'loo' },
    ]
    ...
    testCases.forEach(({ input, cursorPosition, expected }) => {
      ...
      let searchTerm = ''
      if (braceMatch) {
        searchTerm = braceMatch[1].toLowerCase()
      }
...
describe('checkTagTrigger helper function', () => {
  it.concurrent('should return true when there is an unclosed {{ bracket', () => {
    const testCases = [
      { text: 'Hello {{', cursorPosition: 8, expected: true },
      { text: 'Hello {{var', cursorPosition: 11, expected: true },
      { text: 'Hello {{variable.', cursorPosition: 17, expected: true },
    ]
  ...
  it.concurrent('should return false when there is no unclosed {{ bracket', () => {
    const testCases = [
      ...
      { text: 'Hello {{var}}', cursorPosition: 13, expected: false },
      { text: 'Hello {{var}} and more', cursorPosition: 22, expected: false },
  ...
  it.concurrent('should handle edge cases correctly', () => {
    ...
    expect(checkTagTrigger('Hello {{done}} and {{loo', 24).show).toBe(true)

    // Multiple brackets all closed
    expect(checkTagTrigger('Hello {{done}} and {{ok}}', 25).show).toBe(false)
  })
})
