...
const variantStyles = {
  ...
  info: {
    container: 'bg-primary/10 border-primary/30 dark:bg-primary/10 dark:border-primary/30',
    text: 'text-primary dark:text-primary/70',
    title: 'text-primary dark:text-primary/70 font-medium',
    icon: <Info className='mr-2 h-4 w-4 flex-shrink-0 text-primary dark:text-primary/80' />,
  },
  warning: {
