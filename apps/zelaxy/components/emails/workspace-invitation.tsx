...
export const WorkspaceInvitationEmail = ({
  ...
  try {
    ...
    if (invitationLink.includes('/api/arenas/invitations/accept')) {
  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>You've been invited to join the "{workspaceName}" workspace on Zelaxy!</Preview>
        <Container style={baseStyles.container}>
          <Section style={{ padding: '30px 0', textAlign: 'center' }}>
            <Row>
              <Column style={{ textAlign: 'center' }}>
                <Img
                  src={brand.logoUrl || getAssetUrl('static/zelaxy.png')}
                  width='114'
                  alt={brand.name}
                  style={{
                    margin: '0 auto',
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              {inviterName} has invited you to join the "{workspaceName}" workspace on Zelaxy!
            </Text>
            <Text style={baseStyles.paragraph}>
              Zelaxy is a powerful platform for building, testing, and optimizing AI workflows. Join
