  ...
  return (
    <Html>
      ...
      <Body style={baseStyles.main}>
        <Preview>You've been invited to join {organizationName} on Zelaxy</Preview>
        <Container style={baseStyles.container}>
          ...
          <Section style={baseStyles.content}>
            ...
            <Text style={baseStyles.paragraph}>
              ...
              <strong>{organizationName}</strong> on Zelaxy. Zelaxy is a powerful, user-friendly
              platform for building, testing, and optimizing agentic workflows.
            </Text>
            ...
            >
              ...
              an invitation to join {organizationName} on Zelaxy.
            </Text>
          </Section>
        </Container>
