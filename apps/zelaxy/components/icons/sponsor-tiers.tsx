...
export function DiamondTierIcon({ className, size = 16 }: TierIconProps) {
  return (
    <svg
      ...
      aria-hidden='true'
    >
      <path d='M12 2L2 9l10 13L22 9l-10-7z' fill='#b9f2ff' fillOpacity={0.2} stroke='#b9f2ff' strokeWidth={1.5} />
...
export function SilverTierIcon({ className, size = 16 }: TierIconProps) {
  return (
    <svg
      ...
      aria-hidden='true'
    >
      <circle cx={12} cy={12} r={9} fill='#c0c0c0' fillOpacity={0.15} stroke='#c0c0c0' strokeWidth={1.5} />
...
export function BronzeTierIcon({ className, size = 16 }: TierIconProps) {
  return (
    <svg
      ...
      aria-hidden='true'
    >
      <circle cx={12} cy={12} r={9} fill='#cd7f32' fillOpacity={0.15} stroke='#cd7f32' strokeWidth={1.5} />
...
export function SponsorTierIcon({
  tier,
  ...props
}: TierIconProps & { tier: SponsorTier }) {
...
export function SponsorMoneyIcon({ className, size = 16 }: TierIconProps) {
  return (
    <svg
      ...
      aria-hidden='true'
    >
      <circle cx='12' cy='12' r='10' fill='url(#sponsorCoinGrad)' stroke='#f59e0b' strokeWidth={1.5} />
      <path d='M12 6v12' stroke='#92400e' strokeWidth={1.5} strokeLinecap='round' />
      <path d='M9 8.5c0-1 1.5-1.5 3-1.5s3 .5 3 1.5-1.5 1.5-3 2-3 1-3 2 1.5 1.5 3 1.5 3-.5 3-1.5' stroke='#92400e' strokeWidth={1.5} strokeLinecap='round' strokeLinejoin='round' />
      <defs>
