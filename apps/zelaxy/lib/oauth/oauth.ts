    ...
    services: {
      jira: {
        ...
        scopes: [
          ...
          'read:me',
          'offline_access',
          // Jira Service Management. Without these the JSM tools authenticate but every call 403s,
          // and a tool-level additionalScopes cannot fix it — that only drives the credential
          // picker, it does not widen what the provider actually requests.
          ...
          // Assets/CMDB (Jira Premium and above)
