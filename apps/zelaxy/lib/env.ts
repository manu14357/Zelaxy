...
export const env = createEnv({
  ...
  server: {
    ...
    ZELAXY_AGENT_API_URL:                 z.string().url().optional(),            // URL for internal zelaxy agent API
    ...
    ANTHROPIC_API_KEY:                    z.string().min(1).optional(),           // Primary Anthropic Claude API key (fallback)
    ANTHROPIC_API_KEY_1:                  z.string().min(1).optional(),           // Anthropic API key for load balancing
    ...
    NVIDIA_API_KEY:                       z.string().min(1).optional(),           // NVIDIA NIM API key
    GOOGLE_API_KEY:                       z.string().min(1).optional(),           // Google AI (Gemini) API key
    ...
    XAI_API_KEY:                          z.string().min(1).optional(),           // xAI (Grok) API key
    CEREBRAS_API_KEY:                     z.string().min(1).optional(),           // Cerebras API key
    FREESTYLE_API_KEY:                    z.string().min(1).optional(),           // Freestyle AI API key

    // AWS Bedrock Configuration
    BEDROCK_REGION:                       z.string().min(1).optional(),           // AWS Bedrock region (e.g. us-east-1)
    BEDROCK_ACCESS_KEY_ID:                z.string().min(1).optional(),           // AWS access key for Bedrock
    BEDROCK_SECRET_ACCESS_KEY:            z.string().min(1).optional(),           // AWS secret key for Bedrock
    BEDROCK_MODEL_ID:                     z.string().min(1).optional(),           // Default Bedrock model ID
    ...
    // Zelaxy - Privacy-focused configuration - no telemetry or tracking by design
  ...
  client: {
    ...
    NEXT_PUBLIC_BRAND_NAME:               z.string().optional(),                  // Custom brand name (defaults to "Zelaxy")
  ...
  shared: {
    ...
    NEXT_TELEMETRY_DISABLED:              z.string().default('1'),              // Always disable Next.js telemetry - Zelaxy is privacy-focused
  },
  ...
  experimental__runtimeEnv: {
    ...
    NEXT_TELEMETRY_DISABLED: process.env.NEXT_TELEMETRY_DISABLED || '1',  // Always disable telemetry
  },
})
