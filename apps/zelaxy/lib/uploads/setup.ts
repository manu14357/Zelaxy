...
export const S3_EXECUTION_FILES_CONFIG = {
  bucket: env.S3_EXECUTION_FILES_BUCKET_NAME || env.S3_BUCKET_NAME || 'zelaxy-execution-files',
  region: env.AWS_REGION || '',
}
...
export const BLOB_EXECUTION_FILES_CONFIG = {
  ...
  accountKey: env.AZURE_ACCOUNT_KEY || '',
  connectionString: env.AZURE_CONNECTION_STRING || '',
  containerName: env.AZURE_STORAGE_EXECUTION_FILES_CONTAINER_NAME || 'zelaxy-execution-files',
}
