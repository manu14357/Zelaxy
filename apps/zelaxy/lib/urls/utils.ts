 ...
 * @returns The domain with port if applicable (e.g., 'localhost:3000' or 'zelaxy.in')
 */
export function getBaseDomain(): string {
  try {
    ...
    try {
      ...
      return isProd ? 'zelaxy.in' : 'localhost:3000'
    }
  }
}
 ...
 * @returns The email domain (e.g., 'zelaxy.in' instead of 'www.zelaxy.in')
 */
