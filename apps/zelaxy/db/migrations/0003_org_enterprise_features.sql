...
ALTER TABLE "workspace" ADD COLUMN IF NOT EXISTS "organization_id" text REFERENCES "organization"("id") ON DELETE SET NULL;
CREATE INDEX IF NOT EXISTS "workspace_owner_id_idx" ON "workspace" ("owner_id");
...
ALTER TABLE "api_key" ADD COLUMN IF NOT EXISTS "organization_id" text REFERENCES "organization"("id") ON DELETE SET NULL;
...
CREATE INDEX IF NOT EXISTS "audit_log_org_created_at_idx" ON "audit_log" ("organization_id", "created_at");
...
CREATE UNIQUE INDEX IF NOT EXISTS "org_environment_org_id_idx" ON "org_environment" ("organization_id");
