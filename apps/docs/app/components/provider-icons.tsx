...
/**
 * Official provider logos, copied faithfully from the product's own
 * `apps/zelaxy/components/icons/*` — the exact SVG paths/colors the app renders
 * in its model picker. Kept self-contained here so the docs app has no
 * cross-package dependency on `apps/zelaxy`.
 */
...
export function AzureIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24' {...props}>
      <path
        fill='#0078D4'
        d='M9.462 3h5.076L8.846 21H3.77L9.462 3zm4.845 3.11h5.923L11.846 21H5.923l8.384-14.89z'
      />
    </svg>
  )
}
...
export function AzureAnthropicIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24' {...props}>
      <rect fill='#0078D4' width='24' height='24' rx='4' />
      <path
        d='M9.4 5.5 4.5 18h2.9l1-2.7h4.3l1 2.7h2.9L11.7 5.5H9.4zm-.2 7.6L10.5 9l1.3 4.1H9.2z'
        fill='#fff'
      />
    </svg>
  )
...
export function DeepseekIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24' {...props}>
      <circle fill='#4D6BFE' cx='12' cy='12' r='11' />
      <path
        fill='#fff'
        d='M7.5 8.5c0-1.1.9-2 2-2h5c1.1 0 2 .9 2 2v1c0 .83-.5 1.53-1.2 1.82l1.2 1.18v3c0 1.1-.9 2-2 2h-5c-1.1 0-2-.9-2-2v-1c0-.83.5-1.53 1.2-1.82L7.5 11.5V8.5zm2 .5v2h5v-2h-5zm5 4h-5v2h5v-2z'
      />
    </svg>
  )
}
...
export function xAIIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='24' height='24' {...props}>
      <path
        fill='#000'
        d='M2 4h3.6l4.8 7.4L6 18H2.6l4.2-6.6L2 4zm8.2 14H14l6-9.3V4h-3.4L10.2 18zM18 18h3.4V4H18v14z'
      />
    </svg>
  )
}
