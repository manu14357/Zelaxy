...
export const env = createEnv({
  ...
  server: {
    ...
    // REMOVED FOR PRIVACY - Internal agent API authentication
    // AGENT_API_KEY:                     z.string().min(1).optional(),           // Secret for internal agent API authentication
    // AGENT_API_URL:                     z.string().url().optional(),            // URL for internal agent API
    ...
    // Privacy-first configuration - no telemetry or tracking endpoints
    COST_MULTIPLIER:                      z.number().optional(),                  // Multiplier for cost calculations
    COPILOT_COST_MULTIPLIER:              z.number().optional(),                  // Multiplier for copilot cost calculations
    // REMOVED FOR PRIVACY - Error tracking
  ...
  shared: {
    ...
    NEXT_TELEMETRY_DISABLED:              z.string().default('1'),              // Always disable Next.js telemetry - privacy first
  },

  experimental__runtimeEnv: {
    NEXT_PUBLIC_APP_URL: process.env.NEXT_PUBLIC_APP_URL,
    NEXT_PUBLIC_VERCEL_URL: process.env.NEXT_PUBLIC_VERCEL_URL,
    // NEXT_PUBLIC_SENTRY_DSN: process.env.NEXT_PUBLIC_SENTRY_DSN, // REMOVED FOR PRIVACY
