...
The official Python SDK for [Zelaxy](http://localhost:3000/), allowing you to execute workflows programmatically from your Python applications.
...
client = ZelaxyClient(
    api_key=os.getenv("ZELAXY_API_KEY", "your-api-key-here"),
...
```python
ZelaxyClient(api_key: str, base_url: str = "http://localhost:3000/")
```

- `api_key` (str): Your Zelaxy API key
- `base_url` (str, optional): Base URL for the Zelaxy API (defaults to `http://localhost:3000/`)
...
client = ZelaxyClient(
    api_key=os.getenv("ZELAXY_API_KEY"),
    base_url=os.getenv("ZELAXY_BASE_URL", "http://localhost:3000/")
)
```
...
1. Log in to your [Zelaxy](http://localhost:3000/) account
...
# Linting
flake8 zelaxy/ --max-line-length=100
